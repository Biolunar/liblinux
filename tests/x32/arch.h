...
#ifndef HEADER_LIBLINUX_SYSCALL_TESTS_X32_ARCH_H_INCLUDED
#define HEADER_LIBLINUX_SYSCALL_TESTS_X32_ARCH_H_INCLUDED
...
#endif // !HEADER_LIBLINUX_SYSCALL_TESTS_X32_ARCH_H_INCLUDED
