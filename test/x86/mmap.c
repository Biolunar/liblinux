...
{
	intptr_t const ret = linux_syscall6((intptr_t)addr, (intptr_t)len, (intptr_t)prot, (intptr_t)flags, (intptr_t)fd, (intptr_t)(off >> linux_PAGE_SHIFT), linux_syscall_name_mmap_pgoff);
